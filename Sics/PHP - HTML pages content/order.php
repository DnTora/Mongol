										...
										<form id="form_order" method="POST" action="PHP/sendOrder.php">
											<table style="width:100%">
												<tr>
													...
													<td class="orderTextBox"><input type="text" class="form-control" name="fullName" style="width:100%" /></td>
												</tr>
											</table>
											<br />
											<table style="width:100%">
												<tr>
													...
													<td class="orderTextBox"><input type="text" class="form-control" name="emailAddress" style="width:100%" /></td>
												</tr>
											</table>
											<br />
											<table style="width:100%">
												<tr>
													...
													<td class="orderTextBox"><input type="text" class="form-control" name="phoneNumber" style="width:100%" /></td>
												</tr>
											</table>
											<br />
											<table style="width:100%">
											...
											<table style="width:100%">
												<tr>
													<td><p>  הערות:</p></td>
													<td class="orderTextBox"><input type="text" class="form-control" name="notes" style="width:100%" /></td>
												</tr>
											</table>
											<br />
											<table style="width:100%">
												<tr style="vertical-align:top">
													...
													<td class="orderTextBox">
														<table>
															<tr><td class="orderTextBox"><label><input type="radio" name="purchaseType" value="רכישה בודדת" checked /> רכישה בודדת</label></td></tr>
															<tr><td class="orderTextBox"><label><input type="radio" name="purchaseType" value="רכישה מרוכזת" /> רכישה מרוכזת</label></td></tr>
														</table>
													</td>
												</tr>
											</table>
