						...
						<form id="form_registeration" method="POST" action="PHP/register.php">
							<table>
								<tr>
									...
									<td class="registerationTextBox"><input class="loginTextBox form-control" type="text" name="userName" /></td>
								</tr>
							</table>
							<br />
							<table>
								<tr>
									...
									<td class="registerationTextBox"><input class="loginTextBox form-control" type="password" name="password" /></td>
								</tr>
							</table>
							<br />
							<table>
								<tr>
									...
									<td class="registerationTextBox"><input class="loginTextBox form-control" type="password" name="passwordRepeat" /></td>
								</tr>
							</table>
							<br />
							<br />
							<table>
								<tr>
									<td><p>  שם פרטי:</p></td>
									<td class="registerationTextBox"><input class="loginTextBox form-control" type="text" name="privateName" /></td>
								</tr>
							</table>
							<br />
							<table>
								<tr>
									<td><p>  שם משפחה:</p></td>
									<td class="registerationTextBox"><input class="loginTextBox form-control" type="text" name="familyName" /></td>
								</tr>
							</table>
							<br />
							<table>
								<tr>
									<td><p>  אימייל:</p></td>
									<td class="registerationTextBox"><input class="loginTextBox form-control" type="text" name="emailAddress" /></td>
								</tr>
							</table>
							<br />
							<br />
