												...
												echo
													'<form id="form_login" method="POST" action="PHP/login.php">
														<table id="table_loginAreaFields">
															<tr>
																<td><span class="input-group-addon"><span class="glyphicon glyphicon-user"></span></span></td>
																<td><input class="loginTextBox form-control" type="text" name="userName" placeholder="שם משתמש" style="height:100%; width:100%; border-radius:0px" /></td>
															</tr>
															<tr>
																<td><span class="input-group-addon"><span class="glyphicon glyphicon-lock"></span></span></td>
																<td><input class="loginTextBox form-control" type="password" name="password" placeholder="סיסמה" style="height:100%; width:100%; border-radius:0px" /></td>
															</tr>
														</table>
